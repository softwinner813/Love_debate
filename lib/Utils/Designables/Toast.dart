...
class Toast {
  ...
  static void show(String msg, BuildContext context,
    ...
    ToastView.createView(
        msg, context, duration, gravity, textColor, backgroundRadius, border);
  }
}
...
class ToastView {
  ...
  static void createView(String msg, BuildContext context, int duration, int gravity, Color textColor, double backgroundRadius, Border border) async {
